...
public class LunarCalendarUtils {
    ...
    /**
     * 获取农历 year年month月的总天数，总共有13个月包括闰月
     *
     * @param year  将要计算的年份
     * @param month 将要计算的月份
     ...
     * @return YYYY-MM-DD
     */
    public static String getGregorianCalendarDate(int year, int month, int monthDay) {
        //是否闰月
        ...
        int[] lunarToSolar = lunarToSolar(year, month, monthDay, isLeapMonth);
        return lunarToSolar[0] + "-" + lunarToSolar[1] + "-" + lunarToSolar[2];
    }


    public static void main(String[] args) {
        System.out.println(getGregorianCalendarDate(2020, 9, 25));
    }
}
